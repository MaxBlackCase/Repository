...
namespace MyAppModBus.ViewModel
{
   internal class SfChartViewModel : ViewModelBase
   {
      ...
      private void OnSelectItemCommandExecuted(object p)
      {
         ...
         ErrMessage = ctr.ConnectToDevice(_selectedItem, _errMessage, _readWrite);
      ...
      public SfChartViewModel()
      {
         ...
         GetRegistersValues = new LambdaCommand(OnGetRegistersValuesExuted, CanGetRegistersValuesExute);
         #endregion
